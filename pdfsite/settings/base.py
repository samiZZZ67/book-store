...
CLOUDINARY_MAX_UPLOAD_SIZE = env_optional_int(
    "CLOUDINARY_MAX_UPLOAD_SIZE",
    10 * 1024 * 1024,
)
PDF_COMPRESSION_ENABLED = env_bool("PDF_COMPRESSION_ENABLED", True)
PDF_COMPRESSION_MIN_SIZE = env_optional_int(
    "PDF_COMPRESSION_MIN_SIZE",
    CLOUDINARY_MAX_UPLOAD_SIZE or 0,
) or 0
PDF_COMPRESSION_PRESETS = env_list("PDF_COMPRESSION_PRESETS", "/ebook,/screen")
PDF_COMPRESSOR_BINARY = os.environ.get("PDF_COMPRESSOR_BINARY", "gs")
PDF_COMPRESSION_TIMEOUT = int(os.environ.get("PDF_COMPRESSION_TIMEOUT", "120"))
